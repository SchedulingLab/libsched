...
namespace sched::shop {
  ...
  SCHED_API double compute_job_machine_waiting_time(const JobShopTransportSchedule& schedule);
  SCHED_API double compute_job_vehicle_waiting_time(const JobShopTransportSchedule& schedule);
