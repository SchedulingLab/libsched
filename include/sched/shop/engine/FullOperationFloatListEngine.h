...
#ifndef SCHED_SHOP_FULL_OPERATION_FLOAT_LIST_ENGINE_H
#define SCHED_SHOP_FULL_OPERATION_FLOAT_LIST_ENGINE_H
...
namespace sched::shop {
  ...
  struct FullOperationFloatListEngine {
...
namespace sched {
  ...
  template<typename MachineAssignment, typename VehicleAssignment>
  struct EngineTraits<shop::FullOperationFloatListEngine<MachineAssignment, VehicleAssignment>> {
    static std::string name()
    {
      using namespace std::literals;
      return "opf_"s + AssignmentTraits<MachineAssignment>::name() + '_' + AssignmentTraits<VehicleAssignment>::name();
    }
  };

}

#endif // SCHED_SHOP_FULL_OPERATION_FLOAT_LIST_ENGINE_H
